...
export const LampContainer = ({
    ...
    return (
        (<div
            className={cn(
                "absolute top-0 flex h-[40rem] flex-col items-center justify-center bg-slate-950 w-screen rounded-md z-0",
                className
            )}>
            <div
                className="relative flex w-screen flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                <motion.div
                ...
                <div
                    className="absolute top-1/2 h-48 w-screen translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
                <div
                    className="absolute top-1/2 z-50 h-48 w-screen bg-transparent opacity-10 backdrop-blur-md"></div>
                <div
                ...
                <div
                    className="absolute inset-auto z-40 h-44 w-screen -translate-y-[12.5rem] bg-slate-950 "></div>
            </div>
